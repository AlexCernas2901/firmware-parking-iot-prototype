...
#define HOTSPOT_WIFI  "djsk"            /* Nombre del punto de acceso a conectarse */
#define HOTSPOT_PWD   "contrasena"                  /* Contraseña de la red */
...
class MQTT {
  public:
    ...
    void publish_MQTT(void);              /* Conecta al usuario como un publicador MQTT */
...
void MQTT::publish_MQTT(void) {
  String jsonPayload = json.data();  // Obtener el JSON desde la clase JSON

  Serial.println(F("Publicando información"));
  client.publish(TXTOPIC, jsonPayload.c_str());
}
...
void MQTT::setup_WiFi(void) {
  ...
  Serial.println(F("WiFi configurado con la IP: "));
}
...
*                      NOTA: Los parámetros de está función están de acuerdo con los que vienen en la librería Pubsubclient                                    *
* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
